...
└── example/                      # Complete usage example
    ...
    ├── memos-worker/             # Example open-source project
    └── docs/                     # Complete documents generated by the skill
        ├── 1-需求分析.md
        ├── 2-技术架构.md
        ├── 3-数据库设计.md
        └── 4-模块设计.md
...
- **Example Project**: [memos-worker](https://github.com/souvenp/memos-worker) - A serverless note-taking app built on Cloudflare Workers
- **Generated Documents**: [example/docs/](example/docs/) - Complete software engineering documentation produced by this skill

The example shows how to generate from a real open-source project:
- Requirements analysis document
- Technical architecture design document
- Database design document
- Detailed module design document
